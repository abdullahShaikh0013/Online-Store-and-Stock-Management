...
Moving forth, today we'll be working on basic implementation together and tomorrow, we'll continue. I plan to keep Sunday only for testing, seeing as we have other presentations and a project to work on.
